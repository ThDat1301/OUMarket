...
public class OrderService {
    ...
    public static int addOrder(Order o, List<OrderDetails> listOd, boolean checkCus) throws SQLException {
        try (Connection conn = JdbcUtils.getConn()) {
            if (checkCus) {
                int orderId = -1;

                String sql = "INSERT INTO oumarketdb.order (date, totalPrice, moneyCus, customer_id, employee_id) VALUES(?, ?, ?, ?, ?)";
